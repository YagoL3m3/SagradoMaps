  ...
  Widget selecionaBloco(int idBloco) {
    switch (idBloco) {
      ...
      case 5:
        return const ListBody(
          children: [
            ...
            Location('Farmácia  E-007', 'Laboratório de tecnologia\nfarmacêutica'),
            Location('Farmácia  E-009', 'Laboratório de análise\nde medicamentos'),
          ],
        );
      ...
      case 6:
        return const ListBody(
          children: [
            Location('Ciência da Comp. F-008', 'Sala de ciência\n da computação'),
            Location('Cursos EAD  F-004', 'Cursos EAD'),
            Location('Educação física', 'Pátio do bloco F'),
            Location('Jogos Digitais  F-108', 'Laboratório de análise\nde medicamentos'),
      ...
      case 8:
        return const ListBody(
          children: [
            Location('Design de Moda  J-301', 'Laboratório de criação\nem vestuário e acessórios'),
            Location('Gastronomia  J-002', 'Laboratório de gastronomia'),
            Location('Jornalismo', 'Núcleo de produção multimídia'),
            Location('Letras - Português e Inglês', 'Hall dos auditórios João\nPaulo e Madre Cléia'),
            Location('Publicidade e Propaganda', 'Núcleo de produção multimídia'),
      ...
      case 9:
        return const ListBody(
          children: [
            ...
            Location('Estética e Cosmética', 'Laboratório de estética\n e cosmética'),
      ...
      case 10:
        return const ListBody(
          children: [
            Location('Engenharia Ambiental e Sanitária', 'Laboratório de operações\n unitárias'),
            Location('Engenharia de Biotecnologia e Bioprocessos', 'Laboratório de operações\n unitárias'),
            Location('Engenharia Química', 'Laboratório de operações\nunitárias'),
      ...
      case 11:
        return const ListBody(
          children: [
            ...
            Location('Engenharia de Produção', 'Laboratório de Automação\n e Pneumática'),
